...
export const audioPlayer = TurboModuleRegistry.getEnforcing<Spec>('MNTAudioPlayerManager');

export type AudioPlayerNativeEvent = {
  playingTime: number;
};

export const AUDIO_PLAYER_EMITTER_EVENT = {
