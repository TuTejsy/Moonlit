...
- **Placement**: single `LOCKED_CONTENT_PLACEMENT_ID` in `src/constants/common.ts`; variant from Adapty paywall name prefix (`TOGGLE`, `SELECTION`, `SCROLLABLE` base names; postfix A/B names allowed).
